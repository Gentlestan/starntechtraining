    ...
    return (
        <div className="container mx-auto text-center md:text-left px-2 md:ml-16 xl:ml-48">
            <div className="container mx-auto">
                ...
                <h1 className="text-3xl font-bold mt-4">Introduction to Fire Alarm Systems</h1>
                ...
                <h1 className="text-3xl font-bold mt-4">Fundamentals of Fire Detection</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Fire Alarm System Components</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Programming and Configuration</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Maintenance and Testing</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Legal and Regulatory Compliance</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
