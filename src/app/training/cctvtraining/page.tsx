    ...
    return (
        <div className="container mx-auto text-center md:text-left px-2 md:ml-16 xl:ml-48">
            <div className="container mx-auto">
                ...
                <h1 className="text-3xl font-bold mt-4">Introduction to CCTV Systems:</h1>
                ...
                <h1 className="text-3xl font-bold mt-4">Fundamentals of Video Surveillance:</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">CCTV System Components</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">System Design and Planning</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Installation Techniques</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Network Setup and Configuration</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Recording and Storage Management</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Maintenance and Troubleshooting</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-3xl font-bold mt-4">Legal and Ethical Considerations</h1>
                <ul className="list-disc list-inside text-2xl text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
