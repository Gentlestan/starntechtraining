    ...
    return (
        <div className="container mx-auto text-center md:text-left px-2 md:ml-16 xl:ml-48">
            <div className="container mx-auto">
                ...
                <h1 className="text-2xl font-bold mt-4">Introduction to Renewable Energy:</h1>
                ...
                <h1 className="text-2xl font-bold mt-4">Fundamentals of Solar Energy:</h1>
                <ul className="list-disc list-inside text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-2xl font-bold mt-4">Solar System Components:</h1>
                <ul className="list-disc list-inside text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-2xl font-bold mt-4">System Design and Sizing:</h1>
                <ul className="list-disc list-inside text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-2xl font-bold mt-4">Installation Procedures:</h1>
                <ul className="list-disc list-inside text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
                ...
                <h1 className="text-2xl font-bold mt-4">Solar Business Essentials:</h1>
                <ul className="list-disc list-inside text-start xl:text-2xl py-2 ml-0 md:ml-0 xl:ml-0">
